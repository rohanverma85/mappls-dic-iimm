...
The regenerated credential pair supplied on 20 August 2026 is processed by `processDebugMapplsServices` and accepted by the SDK for this debug build. The official Mappls basemap, project marker and operational GIS line overlay were verified on the local Android emulator around Jabalpur. Generate a separate pair for the release signing certificate before distribution.
