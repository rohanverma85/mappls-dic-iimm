    ...
    <main>
      <section className="hero shell-width">
        <div className="hero-copy"><span className="hero-pill">One platform · any infrastructure body · zero code changes</span>
          ...
          <div className="trust-row"><span><Check/> Multi-tenant by design</span><span><Check/> Mappls GIS context</span><span><Check/> Field-ready mobile UX</span></div>
        </div>
...
const moduleDescriptions: Record<string,string> = {
  ...
  'Asset Management':'Configure asset schemas and maintain a spatial infrastructure register on Mappls.',
